-- Corregir la función con el valor correcto del enum y completar la estructura

-- 1. Eliminar las columnas solicitud_id si aún existen
...
-- 2. Crear índices de email para performance
...
-- 3. Crear función para validar si un email tiene solicitud aprobada (con valor correcto)
...
-- 4. Crear función para obtener la cámara de un email
...
-- 5. Recrear todas las políticas RLS usando email como clave de relación
